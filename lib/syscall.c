...
{
	return _syscall(SYS_page_alloc, 1, envid, (uint32_t) va, perm, 0);
}
...
{
	return _syscall(SYS_page_unmap, 1, envid, (uint32_t) va, 0, 0);
}
...
{
	return _syscall(SYS_env_set_status, 1, envid, status, 0, 0);
}

int
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
	return _syscall(SYS_env_set_pgfault_upcall, 1, envid, (uint32_t) upcall, 0, 0);
}
