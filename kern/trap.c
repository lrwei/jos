...
trap_init_percpu(void)
{
	...
	// Prepare MSRs for fast system call.
	extern void sysenter_handler(void);

	wrmsr(IA32_SYSENTER_CS, GD_KT);
	wrmsr(IA32_SYSENTER_ESP, ts->ts_esp0);
	wrmsr(IA32_SYSENTER_EIP, (uint32_t) sysenter_handler);
}
